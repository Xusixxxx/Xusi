...
func (router *Router) Add(patterns Patterns, methods Methods, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Get(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Post(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Put(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Delete(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Head(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Trace(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Connect(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) Options(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
...
func (router *Router) All(pattern string, function func(responseWriter http.ResponseWriter, r *http.Request)) {
